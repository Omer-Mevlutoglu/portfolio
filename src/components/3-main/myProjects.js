export const myProjects = [
  {
    projectTitle: "Modern Html Css Kasper Template",
    description:
  ...
  {
    projectTitle: "Modern Basic Ecommerce Next App",
    description:
  ...
  {
    projectTitle: "Modern Full Stack E-commerce Mernstack",
    description:
  ...
  {
    projectTitle: "Modern Quiz Mobile App Flutter",
    description:
  ...
  {
    projectTitle: "Modern To-do App Using Flutter",
    description:
  ...
  {
    projectTitle: "Modern Basic Income Tracking system",
    description:
  ...
  {
    projectTitle: "Modern Html Css Responsive Template",
    description:
  ...
  {
    projectTitle: "Modern Html Css Advanced Template",
    description:
